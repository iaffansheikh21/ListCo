...
import {faSignInAlt,faSearch,faCaretDown,faBars,faTimes,} from '@fortawesome/free-solid-svg-icons';
    ...
    <div className="relative">
      ...
      >
        ...
        <div className="hidden md:flex items-center space-x-4">
          ...
          <div className="relative">
            <button
              onClick={toggleLanguages}
              className="hover:bg-purple-800 text-black transition duration-500 py-2 px-4 rounded-md flex items-center text-sm md:text-base bg-white border border-gray-700 focus:outline-none focus:ring-2 focus:ring-purple-600 hover:text-white"
            >
              <span className="md:hidden">
                {getLanguageAbbreviation(selectedLanguage)}
              </span>
      ...
      >
        ...
        >
          ...
          <button className="w-full md:w-auto bg-purple-600 hover:bg-purple-700 text-white py-2 px-4 rounded-md flex items-center justify-center focus:outline-none focus:ring-2 focus:ring-purple-600 transition duration-500">
