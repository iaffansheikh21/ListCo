...
const cities = [
  ...
  { name: 'London', listings: '50+', image: '/Rome.png' },
];
        ...
        {cities.map((city) => (
          <div key={city.name} className="relative rounded-lg overflow-hidden shadow-lg group">
            <div className="overflow-hidden rounded-lg">
              <img src={"/NewYork.png"} alt={city.name} className="w-full h-64 object-cover transform transition-transform duration-500 group-hover:scale-110" />
            </div>
