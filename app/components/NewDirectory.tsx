...
const directories = [
  { name: 'Urban areas', description: "Let's uncover the best places to eat, drink", category: 'Food & Restaurant', image: '/newDirectory1' },
  { name: 'Urban areas', description: "Let's uncover the best places to eat, drink", category: 'Food & Restaurant', image: '/newDirectory2' },
  { name: 'Urban areas', description: "Let's uncover the best places to eat, drink", category: 'Food & Restaurant', image: '/newDirectory3' },
];
        ...
        {directories.map((directory, index) => (
          <div key={index} className="flex-shrink-0 w-80">
            <div className="relative">
              <img src={"newDirectory1.png"} alt={"Directory 1"} className="w-full h-48 object-cover rounded-lg" />
