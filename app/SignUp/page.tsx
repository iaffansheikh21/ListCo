        ...
        <div className="w-full max-w-md p-6 bg-white rounded-lg shadow-2xl">
          ...
          <form className="space-y-4">
            ...
            <div>
              <button
                type="submit"
                className="w-full px-4 py-2 font-medium text-white bg-purple-600 rounded-md hover:bg-purple-700 focus:outline-none focus:ring-2 transition duration-500 focus:ring-offset-2 focus:ring-primary"
              >
                Sign Up
              </button>
            </div>
